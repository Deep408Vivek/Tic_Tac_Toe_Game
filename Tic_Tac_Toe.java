...
public class Tic_Tac_Toe implements ActionListener{
        ...
        btn1.setBackground(new Color(222,222,222));
        btn2.setBackground(new Color(222,222,222));
        btn3.setBackground(new Color(222,222,222));
        btn4.setBackground(new Color(222,222,222));
        btn5.setBackground(new Color(222,222,222));
        btn6.setBackground(new Color(222,222,222));
        btn7.setBackground(new Color(222,222,222));
        btn8.setBackground(new Color(222,222,222));
        btn9.setBackground(new Color(222,222,222));
        btn10.setBackground(new Color(222,222,222));
        ...
        btn1.setBorder(BorderFactory.createLineBorder(Color.decode("#2C7654")));
        btn2.setBorder(BorderFactory.createLineBorder(Color.decode("#2C7654")));
        btn3.setBorder(BorderFactory.createLineBorder(Color.decode("#2C7654")));
        btn4.setBorder(BorderFactory.createLineBorder(Color.decode("#2C7654")));
        btn5.setBorder(BorderFactory.createLineBorder(Color.decode("#2C7654")));
        btn6.setBorder(BorderFactory.createLineBorder(Color.decode("#2C7654")));
        btn7.setBorder(BorderFactory.createLineBorder(Color.decode("#2C7654")));
        btn8.setBorder(BorderFactory.createLineBorder(Color.decode("#2C7654")));
        btn9.setBorder(BorderFactory.createLineBorder(Color.decode("#2C7654")));
